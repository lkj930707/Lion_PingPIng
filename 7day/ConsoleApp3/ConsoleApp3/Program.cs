...
namespace ConsoleApp3
{
    internal class Program
    {
        ...
        //매개변수 3개 체력바 출력 
        static void DrawHealthBar(int currnt,int max,int barLength)
        {
            Console.Write("HP[");
            int filledLength = (int)((double)currnt / max * barLength);
